...
Welcome to the GA Elf Scheduling Challenge! The genetic algorithm tutorial and challenge details appear in [genetic_algorithm_challenge.ipynb](https://github.com/drdraad/genetic-algorithm-challenge/blob/challenge/genetic_algorithm_challenge.ipynb)
