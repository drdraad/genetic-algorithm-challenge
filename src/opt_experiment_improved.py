...
def run_improved_experiment(experiment_name: str,
    ...
    ga = ImprovedGA(minimisation_objective_func=calculate_cookie_wages,
                    ...
                    random_injection_probability=random_injection_probability,
                    repair_probability=repair_prob,
                    include_design_knowledge=incl_designs,
                    swap_prob=swap_prob,
                    num_swaps=num_swaps,
                    )
...
if __name__ == "__main__":
    run_improved_experiment(experiment_name='improved_plus')
